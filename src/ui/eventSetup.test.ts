...
function makeMockControllers(): Controllers {
  return {
    gameController: {
      ...
      shuffleRack: vi.fn(),
      submitMove: vi.fn().mockResolvedValue(true),
    ...
    dictionaryController: {
      ...
      downloadRuStrict: vi.fn(),
      refreshDictStatus: vi.fn().mockResolvedValue(undefined),
